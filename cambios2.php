...
<body>
    ...
    <header>
        <h1>Cambio de Datos de Usuario</h1>
    </header>
    ...
    <div class="form-container">
        ...
        if (isset($_REQUEST['usuario'])) {
            ...
            $dinero = mysqli_query($conexion, "SELECT * FROM dp WHERE usuario='$usuario'") or die("Problemas con query");
        ...
        ?>
                <form action="cambios3.php" method="post">
                    ...
                    <input type="text" name="nom" value="<?php echo htmlspecialchars($reg['nom']); ?>" required>

                    <label for="a_p">Apellido Paterno:</label>
                    <input type="text" name="a_p" value="<?php echo htmlspecialchars($reg['a_p']); ?>" required>

                    <label for="a_m">Apellido Materno:</label>
                    <input type="text" name="a_m" value="<?php echo htmlspecialchars($reg['a_m']); ?>" required>

                    <label for="usuario">Usuario:</label>
                    <input type="text" name="usuario" value="<?php echo htmlspecialchars($reg['usuario']); ?>" required>

                    <label for="contrasena">Contraseña:</label>
                    <input type="text" name="contrasena" value="<?php echo htmlspecialchars($reg['contrasena']); ?>" required>

                    <input type="submit" name="ok" value="Editar">
                    <button onclick="window.location.href='cambios1.php';">REGRESAR</button>
