...
<div class="container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $resultado = mysqli_query($conexion, "UPDATE dp SET nom='$nom', a_p='$a_p', a_m='$a_m', usuario='$usuario', contrasena='$contrasena' WHERE usuario='$usuario'") or die("Problemas en el update: " . mysqli_error($conexion));
